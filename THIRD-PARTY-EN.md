...
The self-contained Windows application includes the Microsoft .NET runtime, licensed under MIT. Its license is preserved in vendor/DOTNET-LICENSE.txt and in the Windows release package.
