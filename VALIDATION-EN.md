# VoiceMeeter AEC 1.2.0 — validation

[Français](VALIDATION.md) · Version 1.2.0
...
- English/French desktop checks cover both mixer layouts and channel maps, edition selection, Auto/Balanced defaults, settings migration, mode highlighting, locked audio controls, theme resources, update metadata/checksums, safe archive paths and copy rollback.
...
Framing adds exactly 480 samples / 10 ms, plus optional microphone hold up to 250 ms. AEC has additional internal delay; synthetic near-end alignment is around 19 ms overall at zero hold. This is not hardware end-to-end latency. AEC/bypass uses a 10 ms fade; mute is immediate and unmute fades over 5 ms.
