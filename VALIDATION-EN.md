...
[Français](VALIDATION.md) · Version 1.3.1
...
- English/French desktop checks cover both mixer layouts and channel maps, edition selection, Auto/Strong defaults, 44.1 kHz settings and engine arguments, independent normal-launch/sign-in engine switches, settings migration, mode highlighting, locked audio controls, persistent notification-area closing, theme resources, update metadata/checksums, safe archive paths and copy rollback.
